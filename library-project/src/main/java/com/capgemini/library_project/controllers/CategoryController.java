...
public class CategoryController {
	...
	public ResponseEntity<Category> updateCategory(@PathVariable Long categoryId,
			@Valid @RequestBody Category updatedCategory, BindingResult bindingResult) {
	...
	public ResponseEntity<Category> patchCategory(@PathVariable Long categoryId,
			@Valid @RequestBody Category patchedCategory, BindingResult bindingResult) {
