...
public class ReviewController {
    ...
    public ResponseEntity<Review> assignReviewToBook(@PathVariable Long bookId, @RequestBody Review review) {
    ...
    public ResponseEntity<Review> assignReviewToUser(@PathVariable Long userId, @RequestBody Review review) {
